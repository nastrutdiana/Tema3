...
CREATE TABLE `payments` (
  ...
  CONSTRAINT `customer_id_p` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`)
...
INSERT INTO `payments` VALUES (1,'2022-07-01',100.00),(2,'2022-02-14',300.00),(2,'2022-07-25',270.00);

...
CREATE TABLE `orderdetails` (
  ...
  CONSTRAINT `product_code` FOREIGN KEY (`product_code`) REFERENCES `products` (`code`)
...
INSERT INTO `orderdetails` VALUES (1,'1',2,270.00,1),(2,'1',2,150.00,1),(3,'10',1,39.00,2),(4,'2',2,90.00,2),(5,'5',1,90.00,3);
